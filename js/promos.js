...
var Promos = (function () {
  ...
  return {
    getCode: function (code) { return withTimeout(getCode(code), 10000, 'Checking promo code is taking too long. Please try again.'); },
    getAllCodes: function () { return withTimeout(getAllCodes(), 10000, 'Loading promo codes is taking too long. Please try again.'); },
    createOrUpdateCode: function (code, pct, type, active) { return withTimeout(createOrUpdateCode(code, pct, type, active), 10000, 'Saving promo code is taking too long. Please try again.'); },
    deleteCode: function (code) { return withTimeout(deleteCode(code), 10000, 'Deleting promo code is taking too long. Please try again.'); },
    validateCode: function (code, isFirstOrder) { return withTimeout(validateCode(code, isFirstOrder), 10000, 'Validating promo code is taking too long. Please try again.'); },
